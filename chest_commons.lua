...
chest_on_punch = function(pos, node, puncher, pointed_thing)
	local meta = minetest.get_meta(pos)
	if puncher:get_wielded_item():get_tool_capabilities().groupcaps.locked then
		minetest.chat_send_player(meta:get_string("owner"),"Someone is trying to pick your lock at "..minetest.pos_to_string(pos), true)
	end
end
